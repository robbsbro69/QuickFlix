...
const HeroSection = () => {
  ...
  return (
    ...
    bg-cover bg-center h-screen'>
        ...
        <p className='max-w-md text-gray-300'>In a post-apocalypatic world where cities ride on wheels and consume each other to survive, 
          two people meet in London and try toi stop a conspiracy.  </p>
